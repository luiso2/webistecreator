...
rep('<img src="assets/raw/logo.jpg" alt="Lash Bloom" class="w-10 h-10 rounded-full object-cover ring-1 ring-[rgba(74,160,156,0.35)]" />',
    '<img src="assets/raw/bk-2.jpg" alt="Nina Nails" class="w-10 h-10 rounded-full object-cover ring-1 ring-[rgba(74,160,156,0.35)]" />')
...
rep('''          <div class="glass glass-hover rounded-2xl p-4 text-center"><p class="font-display text-xl text-shine"><span data-count="5.0" data-decimals="1">5.0</span></p><p class="text-[11px] text-[color:var(--ink-40)] uppercase tracking-wide mt-1">Booksy</p></div>
    ...
    '''          <div class="glass glass-hover rounded-2xl p-4 text-center"><p class="font-display text-xl text-shine"><span data-count="5.0" data-decimals="1">5.0</span></p><p class="text-[11px] text-[color:var(--ink-40)] uppercase tracking-wide mt-1">Booksy</p></div>
          ...
          <div class="glass glass-hover rounded-2xl p-4 text-center"><p class="font-display text-xl text-shine">1:1</p><p class="text-[11px] text-[color:var(--ink-40)] uppercase tracking-wide mt-1" data-es="Atención personal" data-en="Personal care">Personal care</p></div>''')
rep('<img src="assets/raw/logo.jpg" alt="Lash Bloom" class="blur-up w-10 h-10 rounded-full object-cover ring-1 ring-[rgba(74,160,156,0.3)]" loading="lazy" />',
    '<img src="assets/raw/bk-2.jpg" alt="Nina Nails" class="blur-up w-10 h-10 rounded-full object-cover ring-1 ring-[rgba(74,160,156,0.3)]" loading="lazy" />')
...
NEW_SERVICES = '''<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 items-stretch">
        ...
        <div class="glass glass-hover rounded-3xl p-7 flex flex-col reveal" style="transition-delay:110ms; border-color: rgba(74,160,156,0.4); box-shadow: 0 18px 50px rgba(34,51,48,0.14);">
...
rep('<img src="assets/raw/logo.jpg" alt="Lash Bloom" class="w-9 h-9 rounded-full object-cover ring-1 ring-[rgba(190,240,236,0.35)]" loading="lazy" />',
    '<img src="assets/raw/bk-2.jpg" alt="Nina Nails" class="w-9 h-9 rounded-full object-cover ring-1 ring-[rgba(190,240,236,0.35)]" loading="lazy" />')
