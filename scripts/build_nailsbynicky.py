...
# ---------- 1. Proteger el badge Merktop (su rgba(212,168,75) coincide con el accent-deep del esqueleto dorado) ----------
m = re.search(r'\.merktop-badge \{.*?@keyframes mkPulse[^\n]*\n', h, flags=re.S)
assert m
badge_block = m.group(0)
h = h.replace(badge_block, '@@BADGE@@', 1)

# ---------- 2. Paleta: rotacion de matiz uniforme (dorado #d4a84b -> vino/borgona) ----------
HUE_SHIFT = -51.0
