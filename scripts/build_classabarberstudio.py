...
# UBICACION
# ============================================================
MAPS_Q = '1011+W+Mohawk+Ave,+Tampa,+FL+33603'
        ...
        <div class="space-y-4">
          <div class="glass glass-hover rounded-2xl p-6 flex items-start gap-4 reveal" style="transition-delay:140ms">
            ...
            <div>
              ...
              <p class="text-sm text-[color:var(--ink-60)] font-light">1011 W Mohawk Ave, Tampa, FL 33603</p>
              <a class="text-sm text-[color:var(--accent-deep)] underline underline-offset-4 decoration-[rgba(107,39,55,0.4)]" href="https://www.google.com/maps?q={MAPS_Q}" target="_blank" rel="noopener" data-es="Cómo llegar" data-en="Get directions">Get directions</a>
            </div>
          </div>
          <div class="glass glass-hover rounded-2xl p-6 flex items-start gap-4 reveal" style="transition-delay:200ms">
            ...
            <div>
              ...
              <a class="text-sm text-[color:var(--accent-deep)] underline underline-offset-4 decoration-[rgba(107,39,55,0.4)]" href="{BK}" target="_blank" rel="noopener" data-es="Reservar en Booksy" data-en="Book on Booksy">Book on Booksy</a>
            </div>
          </div>
          <div class="glass glass-hover rounded-2xl p-6 flex items-start gap-4 reveal" style="transition-delay:260ms">
            ...
            <div>
              ...
              <a class="text-sm text-[color:var(--accent-deep)] underline underline-offset-4 decoration-[rgba(107,39,55,0.4)]" href="{IG}" target="_blank" rel="noopener">@classabarberstudiollc</a>
            </div>
          </div>
        </div>
      </div>
      <div class="frame map-frame reveal min-h-[380px]" style="transition-delay:180ms">
        <iframe title="Map: Class A Barber Studio, 1011 W Mohawk Ave, Tampa FL"
...
# ============================================================
NEW_CTA = f'''<!-- CTA FINAL -->
  <section id="cta-final" class="dark-band relative py-28 sm:py-36 overflow-hidden grain border-t border-[color:var(--accent-ghost)]" style="background: linear-gradient(180deg, #1c0d10 0%, #0f0709 100%);">
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-5 sm:px-8 text-center">
      <p class="reveal font-script text-2xl text-[color:var(--ink-60)] mb-5" data-es="Corte fresco, cada vez." data-en="Fresh cut every time.">Fresh cut every time.</p>
      ...
      <p class="reveal text-[color:var(--ink-60)] font-light mb-10 max-w-xl mx-auto" style="transition-delay:180ms" data-es="Reserva en línea en segundos: tu fade, tu línea de barba, o esa instalación de hair unit que has estado planeando." data-en="Book online in seconds: your fade, your beard line, or that hair unit install you have been planning.">Book online in seconds: your fade, your beard line, or that hair unit install you have been planning.</p>
...
# ============================================================
m_badge_footer = re.search(r'<a href="https://merktop\.com".*?</a>', seg_footer, flags=re.S)
assert m_badge_footer, 'no se encontro merktop-badge en footer original'
MERKTOP_BADGE_HTML = m_badge_footer.group(0)

NEW_FOOTER = f'''<!-- FOOTER -->
  <footer class="dark-band relative overflow-hidden border-t border-[color:var(--accent-ghost)] bg-[#0f0709]">
    <span class="foot-mark" aria-hidden="true">Class A Barber</span>
    <div class="max-w-7xl mx-auto px-5 sm:px-8 py-14 grid sm:grid-cols-3 gap-10">
      <div>
        <div class="flex items-center gap-3 mb-4">
          <img src="assets/raw/bk-2.jpg" alt="Class A Barber Studio logo" class="w-9 h-9 rounded-full object-cover ring-1 ring-[rgba(201,122,140,0.35)] bg-white" loading="lazy" />
          <span class="font-display text-lg tracking-[0.1em] uppercase">Class A Barber Studio</span>
        </div>
        <p class="text-sm text-[color:var(--ink-40)] font-light leading-relaxed" data-es="Barbería en Tampa, FL. Con cita previa vía Booksy." data-en="Barbershop in Tampa, FL. By appointment via Booksy.">Barbershop in Tampa, FL. By appointment via Booksy.</p>
      </div>
      <div class="text-sm font-light text-[color:var(--ink-60)] space-y-2">
        ...
        <p>1011 W Mohawk Ave, Tampa, FL 33603</p>
        <p><a href="{BK}" target="_blank" rel="noopener" class="hover:text-[#e3a9b8]" data-es="Reservas online · Booksy" data-en="Online booking · Booksy">Online booking · Booksy</a></p>
      </div>
      <div class="text-sm font-light text-[color:var(--ink-60)] space-y-2">
        <p class="text-xs tracking-[0.3em] uppercase text-[color:var(--ink-40)] mb-3" data-es="Síguenos" data-en="Follow">Follow</p>
        <p><a href="{IG}" target="_blank" rel="noopener" class="hover:text-[#e3a9b8]">Instagram · @classabarberstudiollc</a></p>
      </div>
    </div>
    <div class="border-t border-[color:var(--accent-ghost)]">
      <div class="max-w-7xl mx-auto px-5 sm:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p class="text-xs text-[color:var(--ink-40)]">© 2026 Class A Barber Studio.</p>
        {MERKTOP_BADGE_HTML}
      </div>
    </div>
  </footer>
...
NEW_BOOKFLOAT = f'''<!-- Boton flotante de reserva -->
  <a href="{BK}" target="_blank" rel="noopener" class="book-float" aria-label="Book appointment online">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#22090d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="m9 16 2 2 4-4"/></svg>
  </a>
...
for word in ['Fades', 'Beard Trims', 'Line-Ups', 'Hair Units', 'Hot Towel Shaves', 'Tampa, FL']:
...
import os
os.makedirs('output/classabarberstudio', exist_ok=True)
