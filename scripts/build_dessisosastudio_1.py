...
# ---------- 2. Paleta: rotacion de matiz uniforme (gold #d4a84b ~41deg -> indigo/azul noche ~230deg) ----------
HUE_SHIFT = 189.0  # grados: gold/champagne -> azul indigo profundo, hueco libre en el proyecto (210-250 sin uso)
