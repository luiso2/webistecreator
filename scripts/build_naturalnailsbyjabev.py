...
NEW_GALLERY = '''<div class="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        ...
        <div class="frame zoomable aspect-[3/4] img-reveal" style="transition-delay:210ms"><span class="tile-cap" data-es="Rojo corto y limpio" data-en="Short, clean red">Rojo corto y limpio</span><img src="assets/raw/bk-11.jpg" alt="Manicure corta en rojo" class="blur-up w-full h-full object-cover" loading="lazy" /></div>
        <div class="frame zoomable aspect-[3/4] lg:mt-10 img-reveal" style="transition-delay:300ms"><span class="tile-cap" data-es="Fransesas cortas" data-en="Short french tips">Fransesas cortas</span><img src="assets/raw/bk-12.jpg" alt="Manicure francesa corta y clasica" class="blur-up w-full h-full object-cover" loading="lazy" /></div>
      </div>
    </div>
  </section>'''
