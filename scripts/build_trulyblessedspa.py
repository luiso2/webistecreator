...
# ---------- 2. Paleta: rotacion de matiz uniforme (mauve/plum-pink #a04a72 -> amethyst/orchid) ----------
HUE_SHIFT = -47.0  # grados: mauve-pink (~332) -> amethyst orchid purple (~285), real color del logo
