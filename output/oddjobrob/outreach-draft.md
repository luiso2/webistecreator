...
- To: oddjobrobswf@gmail.com
- Idempotency-Key: siteforge-oddjobrob-2026-07-18
- Angle: has_own_site = false -> "we built you a sample website"
- Language: English (primary language of the business)

---

**Subject:** A sample website for Odd Job Rob LLC
...
## dm_message (for panel DM/WhatsApp button, max 450 chars)

Hi Rob! This is Michael from Merktop. I saw Odd Job Rob has 4.9 stars and 59 reviews on Google, so I put together a free sample website for you with your real photos and reviews: https://siteforge-demos.odd-forest-9504.workers.dev/oddjobrob/ It doesn't touch your current setup. Happy to put it on your own domain if you like it, or take it down if not, no obligation.

(char count: ~330, within 450 limit)
