...
cd "$(dirname "$0")"
cp ../scripts/research_ig.py ../scripts/maps_common.py ../scripts/maps_research.py ../scripts/maps_discover.py ../scripts/build_maps_site.py ../scripts/derive.py ../scripts/gate.py scripts/
